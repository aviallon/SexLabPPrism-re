// PrismExport addr=0x18003e400 name=anon ghidra=FUN_18003e400 status=clean lines=85

longlong *
FUN_18003e400(longlong *param_1,undefined8 *param_2,int param_3,int *param_4,char param_5,
             undefined8 *param_6)
...
LAB_18003e4eb:
  plVar8 = FUN_180046050(param_6,&local_res8,param_2);
