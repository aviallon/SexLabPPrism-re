// PrismExport addr=0x180014360 name=FocusRecovery::`anonymous-namespace'::StartConsolePulse ghidra=FocusRecovery::_anonymous_namespace_::StartConsolePulse status=clean lines=103
